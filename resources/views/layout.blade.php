...
<div style="position: fixed; z-index: 999; width: 100%">
    ...
    <section id="slider" style="padding-top: 120px"><!--slider-->
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group " id="accordian" style="padding-bottom: 30px"><!--category-productsr-->
        ...
        <div class="container">
            ...
            <div class="footer-right">
                ...
                <p class="footer-company-about">
                    <span style="font-size: 20px">Khiêm táo store</span>
