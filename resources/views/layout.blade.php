...
<body>
                            ...
                            <div class="col-sm-6">
                                <div class="contactinfo">
                                    <ul class="nav nav-pills">
                                        <li><a href="#"><i class="fa fa-phone"></i>0981 110 557</a></li>
                                        <li><a href="#"><i class="fa fa-envelope"></i> nhom2@gmail.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                    ...
                                    <ul class="nav navbar-nav collapse navbar-collapse">
                                        ...
                                        <li class="dropdown"><a href="#">Hãng <i class="fa fa-angle-down"></i></a>
                                            <ul role="menu" class="sub-menu">
                                                ...
                                                <li><a
                                                        href="{{URL::to('/thuong-hieu/'.$value->brand_slug)}}">{{$value->brand_name}}</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                        </li>
                            ...
                            <div class="col-sm-5">
                                <form action="{{URL::to('/tim-kiem')}}" method="POST">
                                    ...
                                    <div class="search_box pull-right">
                                        <input type="text" name="keywords_submit" style="width: 250px"
                                            placeholder="Tìm kiếm sản phẩm" />
                                        <button type="submit" name="search_items" style="padding: 6px 10px"><i
    ...
    <section id="slider" style="padding-top: 120px">
        <!--slider-->
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            $i++;
                            @endphp
                            <div class="item {{$i==1 ? 'active' : '' }}" style="left: -50px">
    ...
    <footer class="footer-distributed" style="background: #1E232B">
        <div class="container">
            <div class="footer-left">
                ...
                <h3>Khiêm Táo <span>Store</span></h3>
                ...
                <p class="footer-company-name" style="color: white">Copyright 2021 Design Nhom2</p>
            </div>
            ...
            <div class="footer-center">
                ...
                <div>
                    ...
                    <p><a href="mailto:nhom2@company.com" style="color: white">nhom2@company.com</a></p>
                </div>
